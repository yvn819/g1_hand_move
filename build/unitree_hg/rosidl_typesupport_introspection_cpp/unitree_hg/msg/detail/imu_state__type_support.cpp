...
{
  new (message_memory) unitree_hg::msg::IMUState(_init);
}

void IMUState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<unitree_hg::msg::IMUState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IMUState_message_member_array[5] = {
  {
    ...
    offsetof(unitree_hg::msg::IMUState, quaternion),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(unitree_hg::msg::IMUState, gyroscope),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(unitree_hg::msg::IMUState, accelerometer),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(unitree_hg::msg::IMUState, rpy),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_hg::msg::IMUState, temperature),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers IMUState_message_members = {
  ...
  5,  // number of fields
  sizeof(unitree_hg::msg::IMUState),
...
get_message_type_support_handle<unitree_hg::msg::IMUState>()
{
  return &::unitree_hg::msg::rosidl_typesupport_introspection_cpp::IMUState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unitree_hg, msg, IMUState)() {
  return &::unitree_hg::msg::rosidl_typesupport_introspection_cpp::IMUState_message_type_support_handle;
}
