...
bool unitree_hg__msg__imu_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_hg.msg._imu_state.IMUState", full_classname_dest, 34) == 0);
  }
  unitree_hg__msg__IMUState * ros_message = _ros_message;
  {  // quaternion
...
{
  /* NOTE(esteve): Call constructor of IMUState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_hg.msg._imu_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IMUState");
