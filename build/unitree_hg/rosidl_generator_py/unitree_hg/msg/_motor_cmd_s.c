...
bool unitree_hg__msg__motor_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_hg.msg._motor_cmd.MotorCmd", full_classname_dest, 34) == 0);
  }
  unitree_hg__msg__MotorCmd * ros_message = _ros_message;
  {  // mode
...
PyObject * unitree_hg__msg__motor_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_hg.msg._motor_cmd");
