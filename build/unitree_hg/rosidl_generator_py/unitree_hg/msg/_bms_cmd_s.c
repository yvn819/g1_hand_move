...
bool unitree_hg__msg__bms_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_hg.msg._bms_cmd.BmsCmd", full_classname_dest, 30) == 0);
  }
  unitree_hg__msg__BmsCmd * ros_message = _ros_message;
  {  // cmd
...
PyObject * unitree_hg__msg__bms_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_hg.msg._bms_cmd");
