...
bool unitree_hg__msg__bms_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_hg.msg._bms_state.BmsState", full_classname_dest, 34) == 0);
  }
  unitree_hg__msg__BmsState * ros_message = _ros_message;
  {  // version_high
  ...
  {  // fn
    PyObject * field = PyObject_GetAttrString(_pymsg, "fn");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->fn = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // cell_vol
  ...
  {  // bmsvoltage
    PyObject * field = PyObject_GetAttrString(_pymsg, "bmsvoltage");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 3;
      uint32_t * dest = ros_message->bmsvoltage;
      for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // soh
    ...
    assert(PyLong_Check(field));
    ros_message->soh = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // temperature
  ...
  {  // manufacturer_date
    PyObject * field = PyObject_GetAttrString(_pymsg, "manufacturer_date");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->manufacturer_date = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // bmsstate
    PyObject * field = PyObject_GetAttrString(_pymsg, "bmsstate");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_UINT32);
      Py_ssize_t size = 5;
      uint32_t * dest = ros_message->bmsstate;
      for (Py_ssize_t i = 0; i < size; ++i) {
        uint32_t tmp = *(npy_uint32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(uint32_t));
      }
...
PyObject * unitree_hg__msg__bms_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_hg.msg._bms_state");
  ...
  {  // fn
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->fn);
    {
      int rc = PyObject_SetAttrString(_pymessage, "fn", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // cell_vol
    ...
    memcpy(dst, src, 40 * sizeof(uint16_t));
    Py_DECREF(field);
  }
  {  // bmsvoltage
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "bmsvoltage");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    uint32_t * src = &(ros_message->bmsvoltage[0]);
  ...
  {  // soh
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->soh);
    {
  ...
  {  // manufacturer_date
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->manufacturer_date);
    {
      int rc = PyObject_SetAttrString(_pymessage, "manufacturer_date", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // bmsstate
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "bmsstate");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_uint32) == sizeof(uint32_t));
    npy_uint32 * dst = (npy_uint32 *)PyArray_GETPTR1(seq_field, 0);
    uint32_t * src = &(ros_message->bmsstate[0]);
