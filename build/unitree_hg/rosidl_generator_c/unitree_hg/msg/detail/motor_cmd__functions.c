...
unitree_hg__msg__MotorCmd__create()
{
  ...
  unitree_hg__msg__MotorCmd * msg = (unitree_hg__msg__MotorCmd *)allocator.allocate(sizeof(unitree_hg__msg__MotorCmd), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(unitree_hg__msg__MotorCmd));
  bool success = unitree_hg__msg__MotorCmd__init(msg);
  if (!success) {
...
unitree_hg__msg__MotorCmd__destroy(unitree_hg__msg__MotorCmd * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    unitree_hg__msg__MotorCmd__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
unitree_hg__msg__MotorCmd__Sequence__init(unitree_hg__msg__MotorCmd__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unitree_hg__msg__MotorCmd * data = NULL;

  if (size) {
    data = (unitree_hg__msg__MotorCmd *)allocator.zero_allocate(size, sizeof(unitree_hg__msg__MotorCmd), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = unitree_hg__msg__MotorCmd__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        unitree_hg__msg__MotorCmd__fini(&data[i - 1]);
      }
...
unitree_hg__msg__MotorCmd__Sequence__fini(unitree_hg__msg__MotorCmd__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      unitree_hg__msg__MotorCmd__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unitree_hg__msg__MotorCmd__Sequence * array = (unitree_hg__msg__MotorCmd__Sequence *)allocator.allocate(sizeof(unitree_hg__msg__MotorCmd__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = unitree_hg__msg__MotorCmd__Sequence__init(array, size);
  if (!success) {
...
unitree_hg__msg__MotorCmd__Sequence__destroy(unitree_hg__msg__MotorCmd__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    unitree_hg__msg__MotorCmd__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
unitree_hg__msg__MotorCmd__Sequence__are_equal(const unitree_hg__msg__MotorCmd__Sequence * lhs, const unitree_hg__msg__MotorCmd__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!unitree_hg__msg__MotorCmd__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  unitree_hg__msg__MotorCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(unitree_hg__msg__MotorCmd);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    unitree_hg__msg__MotorCmd * data =
      (unitree_hg__msg__MotorCmd *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!unitree_hg__msg__MotorCmd__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          unitree_hg__msg__MotorCmd__fini(&output->data[i]);
        }
        return false;
      }
    }
