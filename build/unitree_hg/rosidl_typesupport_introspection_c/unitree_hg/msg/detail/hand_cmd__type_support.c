...
size_t unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__size_function__HandCmd__reserve(
  const void * untyped_member)
{
  (void)untyped_member;
  return 4;
...
const void * unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__get_const_function__HandCmd__reserve(
  const void * untyped_member, size_t index)
{
...
void * unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__get_function__HandCmd__reserve(
  void * untyped_member, size_t index)
{
  uint32_t * member =
...
void unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__fetch_function__HandCmd__reserve(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const uint32_t * item =
    ((const uint32_t *)
    unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__get_const_function__HandCmd__reserve(untyped_member, index));
  uint32_t * value =
    (uint32_t *)(untyped_value);
  *value = *item;
}

void unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__assign_function__HandCmd__reserve(
  void * untyped_member, size_t index, const void * untyped_value)
{
  uint32_t * item =
    ((uint32_t *)
    unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__get_function__HandCmd__reserve(untyped_member, index));
  const uint32_t * value =
    (const uint32_t *)(untyped_value);
  *item = *value;
}

static rosidl_typesupport_introspection_c__MessageMember unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__HandCmd_message_member_array[2] = {
  {
    "motor_cmd",  // name
  ...
  },
  {
    ...
    4,  // array size
    false,  // is upper bound
    offsetof(unitree_hg__msg__HandCmd, reserve),  // bytes offset in struct
    NULL,  // default value
    unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__size_function__HandCmd__reserve,  // size() function pointer
    unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__get_const_function__HandCmd__reserve,  // get_const(index) function pointer
    unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__get_function__HandCmd__reserve,  // get(index) function pointer
    unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__fetch_function__HandCmd__reserve,  // fetch(index, &value) function pointer
    unitree_hg__msg__HandCmd__rosidl_typesupport_introspection_c__assign_function__HandCmd__reserve,  // assign(index, value) function pointer
