...
static rosidl_typesupport_introspection_c__MessageMember unitree_hg__msg__PressSensorState__rosidl_typesupport_introspection_c__PressSensorState_message_member_array[4] = {
  {
    "pressure",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_hg__msg__PressSensorState, lost),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unitree_hg__msg__PressSensorState, reserve),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
