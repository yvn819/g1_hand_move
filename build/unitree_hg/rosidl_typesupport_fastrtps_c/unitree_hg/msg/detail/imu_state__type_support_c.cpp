...
#include "unitree_hg/msg/detail/imu_state__rosidl_typesupport_fastrtps_c.h"
...
using _IMUState__ros_msg_type = unitree_hg__msg__IMUState;
...
static uint32_t _IMUState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unitree_hg__msg__IMUState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unitree_hg__msg__IMUState;
    is_plain =
      (
...
static size_t _IMUState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unitree_hg__msg__IMUState(
